...
static int __set_phy_supported(struct phy_device *phydev, u32 max_speed)
{
	...
	linkmode_set_bit(ETHTOOL_LINK_MODE_10baseT_Half_BIT, speeds);
	linkmode_set_bit(ETHTOOL_LINK_MODE_10baseT_Full_BIT, speeds);
	linkmode_set_bit(ETHTOOL_LINK_MODE_100baseT_Half_BIT, speeds);
	linkmode_set_bit(ETHTOOL_LINK_MODE_100baseT_Full_BIT, speeds);
	linkmode_set_bit(ETHTOOL_LINK_MODE_1000baseT_Half_BIT, speeds);
	linkmode_set_bit(ETHTOOL_LINK_MODE_1000baseT_Full_BIT, speeds);
