/* drivers/net/wan/qmc.h : definitions for QMC HDLC on PEF2256 driver for Linux
 *
 * This software may be used and distributed according to the terms of the
 * GNU General Public License.
 */

#ifndef _QMC_PEF2256_H
#define _QMC_PEF2256_H
...
#define TS_1		0x00000001
#define TS_ALL		0x7FFFFFFF

#define VERSION_UNDEF	0
#define VERSION_1_2	0x12
#define VERSION_2_1	0x21
#define VERSION_2_2	0x22
...
#define GIS_INT4	(1 << 4)
#define GIS_INT5	(1 << 5)
#define GIS_INT_ALL	(GIS_INT0 | GIS_INT1 | GIS_INT2 | \
			 GIS_INT3 | GIS_INT4 | GIS_INT5)
#define INT2_LOS	(1 << 2)
#define INT2_AIS	(1 << 3)
#define LIM0_MAS	(1 << 0)
...
struct pef2256_dev_priv {
	...
	u32 hdlc_TS;	/* Transmit/Receive Time Slots */
